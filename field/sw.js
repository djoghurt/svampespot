const CACHE = 'svampespot-field-v24';
const SHELL = [
  './',
  './index.html',
  './app.js?v=2026-08-17-19',
  './core.js',
  './default-spots.js?v=2026-08-17-19',
  './map.js?v=2026-08-17-19',
  './map-modes.js?v=2026-08-17-19',
  './rank-display.js?v=2026-08-17-19',
  './spot-mode.js?v=2026-08-17-19',
  './storage.js',
  './styles.css',
  './spot-styles.css',
  './weather.js',
