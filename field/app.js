...
import {
  ...
  nearestMapRegion,
  REGION_DETAIL_ZOOM,
} from './default-spots.js?v=2026-08-17-15';
import { createFieldMap } from './map.js?v=2026-08-17-15';
import { createSpotMode } from './spot-mode.js?v=2026-08-17-15';
...
async function initialize() {
  ...
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('./sw.js?v=2026-08-17-15', {
      updateViaCache: 'none',
